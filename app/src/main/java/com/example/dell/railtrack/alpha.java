...
public class alpha extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtconfirm = (TextView)findViewById(R.id.textView9);
        edconfirm = (EditText)findViewById(R.id.editText8);
        btnconfirm = (Button)findViewById(R.id.button5);

        btnconfirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String otp = edconfirm.getText().toString();
                Intent tothree = new Intent(alpha.this,three.class);
